  ...
  useEffect(() => {
    ...
    if (user) {
      if (user.role === "admin") {
        ...
        navigate("/course-shell", { replace: true });
      }
    }
      ...
      <div className="login-left">
        <div className="login-content">
          ...
          <form onSubmit={handleSubmit} className="login-form" noValidate>
            ...
            <div className="remember-me-group" style={{ display: 'flex', alignItems: 'center', marginBottom: '16px', marginTop: '8px' }}>
              <input
                type="checkbox"
                checked={rememberMe}
              ...
              />
              <label style={{ fontSize: '14px', cursor: 'pointer', userSelect: 'none' }}>
                Remember me
              </label>
            </div>
