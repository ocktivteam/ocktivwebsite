...
// // === QUIZ INTEGRATION IMPORTS ===
// import QuizList from "./quizList";
// import { FaQuestionCircle } from "react-icons/fa";
// // === END QUIZ INTEGRATION IMPORTS ===
...
//   const [selectedSidebar, setSelectedSidebar] = useState("module"); // "module" or "quiz"
//   // === END QUIZ INTEGRATION STATE ===
...
//   function handleModuleSelect(idx) {
//     setSelectedIdx(idx);
//     setSelectedSidebar("module"); // QUIZ INTEGRATION: Switch back to module view
//     if (modules[idx]?._id && courseId && user?._id) {
//       localStorage.setItem(`lastSelectedModule_${user._id}_${courseId}`, modules[idx]._id);
//     }
//   }
...
//              {/* === QUIZ SIDEBAR ITEM START === */}
// <div
//   className={
//     "allcontent-module-item" +
//     (selectedSidebar === "quiz" ? " selected" : "") +
//     ((user?.role === "student" && (completedModules !== totalModules || totalModules === 0)) ? " locked" : "")
//   }
//   tabIndex={(user?.role === "student" && (completedModules !== totalModules || totalModules === 0)) ? -1 : 0}
//   onClick={() => {
...
//   <span className="allcontent-module-meta">
//     <span className="allcontent-module-status locked">Not Started</span>
//     {(user?.role === "student" && (completedModules !== totalModules || totalModules === 0)) && (
//       <FaLock className="lock-icon" />
//     )}
//   </span>
// </div>
// {/* === QUIZ SIDEBAR ITEM END === */}
...
//               courseId={courseId}
//               user={user}
//               locked={user?.role === "student" && (completedModules !== totalModules || totalModules === 0)}
//               quizTitle="Quiz"
//             />
//           ) : (
//             selectedModule && (
...
export default function AllContent() {
  ...
  const [deleting, setDeleting] = useState(false);
  const [error, setError] = useState("");
  const [selectedSidebar, setSelectedSidebar] = useState("module");
