...
//                     <div className="profile-value">{getFullName()}</div>
...
const Profile = () => {
  ...
  // --------- One-time Full Legal Name editing ----------
              ...
              <div className="profile-actions">
                ...
                {!isInstructor && (
                  !legalNameEditedOnce ? (
                    ...
                    <span className="profile-change-password-link" style={{ cursor: 'default', textDecoration: 'none' }}>
                      You already changed your Full Legal Name once. For further changes, contact support@ocktiv.com
                    </span>
                  )
                )}
